...
from model.pretrainmodels.local_attention import LocalAttention
from model.pretrainmodels.reversible import ReversibleSequence, SequentialSequence
...
class Performer(nn.Module):
    def __init__(
        ...
        local_attn_heads = 4,               # num of local attention heads, (heads - local_attn_heads) is num of global performers
        ...
        reversible = True,                 # reversible layers, from Reformer (save memory)
        ff_chunks = 10,                      # chunk feedforward layer, from Reformer
        ...
        ff_glu = True,                     # use GLU (Gated Linear Units) variant for feedforward
