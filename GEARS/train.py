...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_name', type=str, default='dixit')
    ...
    parser.add_argument('--singlecell_model_path', type=str, default='/guoxiaopeng/wangjue/VQCell/VQCellV2/model/models/models.ckpt')
    parser.add_argument('--finetune_method', type=str, default='frozen')
