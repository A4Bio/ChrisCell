...
parser.add_argument('--data_path', type=str, default='/guoxiaopeng/wangjue/data/celldata/all_test_datasets/brain_sub.h5ad', help='input data path')
...
def main():
    ...
    if args.data_path[-3:]=='npz':
        ...
        idx = list(range(gexpr_feature.shape[0]))
    
        col = pd.read_csv('/guoxiaopeng/wangjue/VQCell/VQCell/feature.csv').feature_name.tolist()
...
#        print('covert gene feature into 19264')
    ...
    geneexpemb=[]
    batchcontainer = []
    strname = os.path.join(args.save_path, args.task_name +'_'+ args.ckpt_name +"_"+ args.input_type + '_' + args.output_type + '_embedding_' + args.tgthighres + '_resolution1.npy')
