...
# print(FT3_val.mean(), FT3_val.min(), FT3_val.max())
    ...
    def forward(self, h_in, attn_mask=None, mode='train', temperature=1, vqshortcut=False, level = 8):
        ...
        #        print(level)
                quantized_, code, vq_loss_, embed = self.sample_code(h, level, temperature, attn_mask)
            ...
            print(level)
            quantized, code, vq_loss, embed = self.sample_code(h, level, temperature, attn_mask)
