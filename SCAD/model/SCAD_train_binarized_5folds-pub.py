...
parser.add_argument('--lr', default=1e-3,help='lam1',type=float)
...
if emb ==1:
    tr_ts_summary_path = "./emb_results_"+ args.ckpt_name +feature+"/"+DRUG+"_train_test_summary_5folds_5seeds.txt"
else:
...
if emb ==1:
    ...
    if cell_lines != "solid":
        SAVE_RESULTS_TO = "./emb_results_"+ args.ckpt_name +feature+"/" + DRUG + "/" + MODE + "/" + 'seed' + str(init_seed) + "/"
        SAVE_TRACE_TO = "./emb_results_"+ args.ckpt_name +feature+"/" + DRUG + "/" + MODE + "/trace/" + 'seed' +  str(init_seed) + "/"
        SOURCE_DIR = 'source_5_folds'

    TARGET_DIR = 'target_5_folds'

    if cell_lines == "solid":
        SAVE_RESULTS_TO = "./emb_results_vqcell_solid" + feature + "/" + DRUG + "/" + MODE + "/" + 'seed' + str(init_seed) + "/"
        SAVE_TRACE_TO = "./emb_results_vqcell_solid" + feature + "/" + DRUG + "/" + MODE + "/trace/" + 'seed' + str(init_seed) + "/"
        SOURCE_DIR = 'source_solid_5_folds'

    LOAD_DATA_FROM = 'data/split'+geneset+'/' + DRUG + '/stratified_emb_' + args.ckpt_name + '/'
